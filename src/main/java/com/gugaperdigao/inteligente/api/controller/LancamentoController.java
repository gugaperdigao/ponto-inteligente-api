...
import com.gugaperdigao.inteligente.api.dto.LancamentoDto;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<List<LancamentoDto>>> listarPorFuncionarioId(
		...
		Sort sort;
		List<Lancamento> lancamentos = this.lancamentoService.buscarPorFuncionarioId(funcionarioId, PageRequest.of(pag, qtdPorPagina, Sort.by(ord)));
		List<LancamentoDto> lancamentosDto = new ArrayList<LancamentoDto>();
		for (Iterator iterator = lancamentos.iterator(); iterator.hasNext();) {
			Lancamento lancamento = (Lancamento) iterator.next();
			lancamentosDto.add(this.converterLancamentoDto(lancamento));
